...
* [xLights](https://xlights.org/) - Meant for home Christmas light shows but is a great way to sync lights to music on a budget. [Source Code](https://github.com/smeighan/xLights) ⭐ 748 | 🐛 47 | 🌐 C++ | 📅 2026-09-12 `✓ open-source`.
...
* [Ardour](https://ardour.org/) - A full realtime audio recording and editing suite. [Source Code](https://github.com/Ardour/ardour) ⭐ 5,279 | 🐛 49 | 🌐 C++ | 📅 2026-09-12 `✓ open-source`.
...
* [Ontime](https://github.com/cpvalente/ontime) ⭐ 948 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-11 - Browser-based application that manages event rundowns, scheduling, and cueing. Plan, track your schedule, manage automation and cross-department show information in one place. `✓ open-source`.
...
* [meters.lv2](https://github.com/x42/meters.lv2) ⭐ 225 | 🐛 17 | 🌐 C | 📅 2026-09-07 - meters.lv2 is a collection of audio-level meters with GUI in LV2 plugin format. `✓ open-source`.
...
* [awesome-linuxaudio](https://github.com/nodiscc/awesome-linuxaudio) ⭐ 1,784 | 🐛 3 | 🌐 Makefile | 📅 2026-07-31 - A Awesome list with all things Linux audio.
