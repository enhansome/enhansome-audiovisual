...
Want to add something? Just make a pull request, but be sure to follow the [contributing guidelines](./contributing.md)! Question? Ask it in the [General Discussion issue](https://github.com/stingalleman/awesome-audiovisual/issues/2) ⭐ 268 | 🐛 1 | 📅 2026-07-21.
...
* [QLC+](https://www.qlcplus.org/) - QLC+ is a free and cross-platform software to control DMX or analog lighting systems like moving heads, dimmers, scanners etc. [Source Code](https://github.com/mcallegari/qlcplus) ⭐ 1,512 | 🐛 56 | 🌐 C++ | 📅 2026-08-27 `✓ open-source`.
* [xLights](https://xlights.org/) - Meant for home Christmas light shows but is a great way to sync lights to music on a budget. [Source Code](https://github.com/smeighan/xLights) ⭐ 746 | 🐛 46 | 🌐 C++ | 📅 2026-08-28 `✓ open-source`.
...
* [Ardour](https://ardour.org/) - A full realtime audio recording and editing suite. [Source Code](https://github.com/Ardour/ardour) ⭐ 5,236 | 🐛 46 | 🌐 C++ | 📅 2026-08-27 `✓ open-source`.
...
See [ebu/awesome-broadcasting](https://github.com/ebu/awesome-broadcasting#readme) ⭐ 1,766 | 🐛 13 | 📅 2026-04-29.

## Tools

**[`^        back to top        ^`](#Contents)**

* [Ontime](https://github.com/cpvalente/ontime) ⭐ 943 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-28 - Browser-based application that manages event rundowns, scheduling, and cueing. Plan, track your schedule, manage automation and cross-department show information in one place. `✓ open-source`.
...
* [Timecode](https://github.com/MrExplode/Timecode) ⭐ 63 | 🐛 2 | 🌐 Java | 📅 2026-08-16 - ArtNet and LTC timecode generator, made with Java. `✓ open-source`.
...
* [awesome-linuxaudio](https://github.com/nodiscc/awesome-linuxaudio) ⭐ 1,774 | 🐛 2 | 🌐 Makefile | 📅 2026-07-31 - A Awesome list with all things Linux audio.
...
* [MIDI Monster](https://github.com/cbdevnet/midimonster/) ⭐ 603 | 🐛 50 | 🌐 C | 📅 2024-06-24 - MIDIMonster is a universal control and translation tool. It can translate between many different protocols such as MIDI, Artnet, sACN and OSC. `✓ open-source`.
